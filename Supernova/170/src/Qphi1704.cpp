...
//lambda_phi-1 = Q_phi /xi_value / rho_phi * MeV_to_1/cm
//lambda_phi = 1.0 / lambda_phi_inverse * 2.1894549080 * 2.15
...
double calculate_lambda_phi_inverse(double Q_phi, double rho_phi, double xi_value) {
    return Q_phi /xi_value / rho_phi * MeV_to_inv_cm;
}
...
int main() {
    ...
    // 打开 CSV 文件
    std::ofstream outputFile("/home/fyq/DIYbyfyq/Experimentbound/Supernova/170/data/data4.csv");
    if (!outputFile) {
